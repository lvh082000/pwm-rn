    ...
    <View style={[l.mt5, l.flexRow, l.p10, {backgroundColor: c.black800}]}>
      <View style={[l.flex, l.pr5, l.pb30]}>
        ...
        <View style={[{height: 150}, l.pt5]}>
          <Image
            source={{uri: postMedia[1].media_url}}
            resizeMode="stretch"
            style={[l.fullSize]}
          />
        </View>
      ...
      <View style={[l.flex, l.pl5, l.pt30]}>
        <View style={[{height: 100}, l.pb5]}>
          <Image
            source={{uri: postMedia[2].media_url}}
            resizeMode="stretch"
            style={[l.fullSize]}
          />
        </View>
        ...
        <View style={[{height: 100}, l.pt5]}>
          <Image
            source={{uri: postMedia[4].media_url}}
            resizeMode="stretch"
            style={[l.fullSize]}
          />
        </View>
